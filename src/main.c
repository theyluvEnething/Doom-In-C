    ...
    while (mn_wnd_running || db_wnd_running) 
    {
        ...
        if (!is_minimized(&frame)) {
            ...
            for (int n = 0; n < MAX_VERTS; n++) {
                for (int i = 0; i < walls[n].vertCount-1; i++) {
                    ...
                    const f32 z1 = dist1.x*cos(player.lookangle) + dist1.y*sin(player.lookangle),
                    ...
                    drawline(vec2(centerScreenW + x1, centerScreenH + y1a), vec2(centerScreenW + x2, centerScreenH + y2a), 2, 0xFF0000, &frame);
                    drawline(vec2(centerScreenW + x1, centerScreenH + y1b), vec2(centerScreenW + x2, centerScreenH + y2b), 2, 0xFF0000, &frame);
                    drawline(vec2(centerScreenW + x1, centerScreenH + y1a), vec2(centerScreenW + x1, centerScreenH + y1b), 2, 0xFF0000, &frame);
                    drawline(vec2(centerScreenW + x2, centerScreenH + y2a), vec2(centerScreenW + x2, centerScreenH + y2b), 2, 0xFF0000, &frame);
                }
            }
